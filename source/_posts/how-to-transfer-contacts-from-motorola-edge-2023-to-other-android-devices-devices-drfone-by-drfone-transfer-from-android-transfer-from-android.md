---
title: How to Transfer Contacts from Motorola Edge 2023 to Other Android Devices Devices? | Dr.fone
date: 2024-03-21 15:45:56
updated: 2024-03-22 20:54:12
tags: 
  - transfer
categories:
  - android
...
keywords: transfer from Motorola Edge 2023 to pc,transfer from android to mac,transfer from android to ipad,transfer from Motorola Edge 2023 to ipad,transfer from Motorola Edge 2023 to android,transfer from android to pc,transfer from android to android,transfer from Motorola Edge 2023 to iphone,transfer from Motorola Edge 2023 to mac
...
## How I Transferred Messages from Motorola Edge 2023 to iPhone 12/XS (Max) in Seconds

Recently, I got a new iPhone 12/XS (Max) with so much excitement. But, the one thing that was driving me crazy was how to transfer messages from my old Android device to this iPhone 12/XS (Max), as I have always been an Android phone user till then. So, I was scared to [transfer anything to the new iPhone](https://drfone.wondershare.com/transfer-to-new-iphone.html) and ruin it. You can have numerous solutions to transfer text messages from Motorola Edge 2023 to iPhone 12/XS (Max) after setup.
...
## 2 Apps to Transfer Messages from Motorola Edge 2023 to iPhone 12/XS (Max) without Computer

### How to transfer Android messages to iPhone 12/XS (Max) using Move to iOS app

The first method to transfer text messages from Motorola Edge 2023 to iPhone 12/XS (Max) is using the official Move to iOS app from Apple. Message history, call logs, contacts, web bookmarks, apps, etc. can be transferred from your Android to any iOS device. Though, I have noticed the app was acting strangely during data transfer. My Wi-Fi got some issues, and Move to iOS couldn’t properly complete the transfer.

**Guide for Move to iOS** **to transfer messages from Motorola Edge 2023 to iPhone 12/XS (Max)**

1. Download, install, and launch Move to iOS on your Motorola Edge 2023.
...
3. On your Motorola Edge 2023, click ‘Continue’ and then press ‘Agree’. When prompted for a passcode, enter the one you got from iPhone 12/XS (Max).
...
You can learn how to transfer messages from Motorola Edge 2023 to iPhone 12/XS (Max) without a computer using the SMS Backup+ app. It can automatically backup the SMS, call logs, MMS using a different label in Google Calendar and Gmail. Remember that MMS can’t be restored later.

**Here is how to transfer messages from Motorola Edge 2023 to iPhone 12/XS (Max) with SMS Backup+:**
...
2. Download SMS Backup+ on your Motorola Edge 2023 from Google Play Store and launch it. Tap ‘Connect’ choose the recently used Gmail account. Now, allow the app to backup the SMS to your Gmail account and hit ‘Backup’.
...
## 2 Methods to Transfer Messages from Motorola Edge 2023 to iPhone 12/XS (Max) with a PC

### How to transfer all messages to iPhone 12/XS (Max) at a time

For transferring messages from your Motorola Edge 2023 to iPhone 12/XS (Max), opting for [Dr.Fone - Phone Transfer](https://tools.techidaily.com/wondershare/drfone/phone-switch/) is a great idea. Speak of transferring contacts, photos, music, text messages, etc. from Motorola Edge 2023 to iOS devices or vice versa, it has a proven record of credibility.
...
Alternatively, you can opt for [Dr.Fone - Phone Manager](https://drfone.wondershare.com/iphone-transfer.html) for selectively transferring messages from your Motorola Edge 2023 to your iPhone. Managing your iPhone is easy with such an effective desktop tool.



### [Dr.Fone - Phone Manager (iOS)](https://drfone.wondershare.com/iphone-transfer.html "iphone transfer")

Quickly and Selectively Transfer Messages from Motorola Edge 2023 to iPhone 12/XS (Max)
...
## How to Transfer Contacts from Motorola Edge 2023 to Other Android Devices Using Bluetooth?
...
## Part I: How to Transfer Contacts from Motorola Edge 2023 to Other Android Devices via Bluetooth?
...
## Part II: Other Methods to Transfer Contacts from Motorola Edge 2023 to Other Android Devices
...
Step 2: Keep the Motorola Edge 2023 devices close by, say, on the table. This will not work if the Motorola Edge 2023 devices are in different rooms or too far away.

Step 3: Launch Smart Switch on both the Motorola Edge 2023 devices
...
In that regard, using a third-party solution such as Dr.Fone allows you complete freedom to do whatever you want and whenever you want, and even so, Dr.Fone is a great tool to have in one’s arsenal to use every day. How? Because not only does Dr.Fone allow you to transfer contacts from one Android device to another, you have complete freedom to mix the Motorola Edge 2023 devices in all possible ways. So, if you want to transfer from Samsung to Xiaomi, you can do that. You want to transfer from Xiaomi to Samsung, Dr.Fone does that. Transfer from Apple iPhone to Xiaomi? Yes! Xiaomi or Samsung to Apple iPhone? You bet, all supported! And with a clean, easy-to-use interface that does the job quickly and safely.

### II.III: Transfer Contacts from Motorola Edge 2023 to Other Android Devices Using Dr.Fone - Phone Transfer

### Video Tutorial: How to Transfer Data from Motorola Edge 2023 to Other Android Devices
...
Step 3: Select the Phone Transfer module and connect your Motorola Edge 2023s to the computer

![phone transfer](https://images.wondershare.com/drfone/guide/transfer-ios-to-android-1.png)

Step 4: When the Motorola Edge 2023 devices are connected, select the Contacts category to transfer and click Start Transfer. Within seconds, your contacts will be transferred to the new device.
