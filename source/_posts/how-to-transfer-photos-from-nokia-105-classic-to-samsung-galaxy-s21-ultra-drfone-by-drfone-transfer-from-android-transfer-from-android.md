---
title: How to Transfer Photos From Nokia 105 Classic to Samsung Galaxy S21 Ultra | Dr.fone
date: 2024-07-17T20:38:53.640Z
updated: 2024-07-18T20:38:53.640Z
tags: 
  - transfer
categories:
  - android
...
keywords: transfer from Nokia 105 Classic to mac,transfer from Nokia 105 Classic to android,transfer from android to android,transfer from android to mac,transfer from android to iphone,transfer from Nokia 105 Classic to ipad,transfer from android to pc
...
## How I Transferred Messages from Nokia 105 Classic to iPhone 12/XS (Max) in Seconds

Recently, I got a new iPhone 12/XS (Max) with so much excitement. But, the one thing that was driving me crazy was how to transfer messages from my old Android device to this iPhone 12/XS (Max), as I have always been an Android phone user till then. So, I was scared to [transfer anything to the new iPhone](https://drfone.wondershare.com/transfer-to-new-iphone.html) and ruin it. You can have numerous solutions to transfer text messages from Nokia 105 Classic to iPhone 12/XS (Max) after setup.
...
## 2 Apps to Transfer Messages from Nokia 105 Classic to iPhone 12/XS (Max) without Computer
...
The first method to transfer text messages from Nokia 105 Classic to iPhone 12/XS (Max) is using the official Move to iOS app from Apple. Message history, call logs, contacts, web bookmarks, apps, etc. can be transferred from your Android to any iOS device. Though, I have noticed the app was acting strangely during data transfer. My Wi-Fi got some issues, and Move to iOS couldn’t properly complete the transfer.

**Guide for Move to iOS** **to transfer messages from Nokia 105 Classic to iPhone 12/XS (Max)**

1. Download, install, and launch Move to iOS on your Nokia 105 Classic.
...
3. On your Nokia 105 Classic, click ‘Continue’ and then press ‘Agree’. When prompted for a passcode, enter the one you got from iPhone 12/XS (Max).
...
You can learn how to transfer messages from Nokia 105 Classic to iPhone 12/XS (Max) without a computer using the SMS Backup+ app. It can automatically backup the SMS, call logs, MMS using a different label in Google Calendar and Gmail. Remember that MMS can’t be restored later.

**Here is how to transfer messages from Nokia 105 Classic to iPhone 12/XS (Max) with SMS Backup+:**
...
2. Download SMS Backup+ on your Nokia 105 Classic from Google Play Store and launch it. Tap ‘Connect’ choose the recently used Gmail account. Now, allow the app to backup the SMS to your Gmail account and hit ‘Backup’.
...
## 2 Methods to Transfer Messages from Nokia 105 Classic to iPhone 12/XS (Max) with a PC

### How to transfer all messages to iPhone 12/XS (Max) at a time

For transferring messages from your Nokia 105 Classic to iPhone 12/XS (Max), opting for [Dr.Fone - Phone Transfer](https://tools.techidaily.com/wondershare/drfone/phone-switch/) is a great idea. Speak of transferring contacts, photos, music, text messages, etc. from Nokia 105 Classic to iOS devices or vice versa, it has a proven record of credibility.
...
Alternatively, you can opt for [Dr.Fone - Phone Manager](https://drfone.wondershare.com/iphone-transfer.html) for selectively transferring messages from your Nokia 105 Classic to your iPhone. Managing your iPhone is easy with such an effective desktop tool.



### [Dr.Fone - Phone Manager (iOS)](https://drfone.wondershare.com/iphone-transfer.html "iphone transfer")

Quickly and Selectively Transfer Messages from Nokia 105 Classic to iPhone 12/XS (Max)
...
<div><ul>
<li><a href="https://youtube-help.techidaily.com/new-expand-your-viewership-horizon-on-youtube/"><u>[New] Expand Your Viewership Horizon on Youtube</u></a></li>
...
<li><a href="https://tiktok-video-files.techidaily.com/in-2024-comprehensive-steps-for-achieving-excellent-slow-motion-on-tiktok/"><u>In 2024, Comprehensive Steps for Achieving Excellent Slow Motion on TikTok</u></a></li>
