---
title: How to Transfer Contacts from Honor X9b to Outlook | Dr.fone
date: 2024-03-19 21:52:11
...
keywords: transfer from Honor X9b to mac,transfer from android to mac,transfer from Honor X9b to android,transfer from Honor X9b to ipad,transfer from Honor X9b to iphone,transfer from android to iphone,transfer from Honor X9b to pc,transfer from android to android,transfer from android to ipad,transfer from android to pc
...
## [Solved] Move from Honor X9b to iOS not Working Problems
...
Once you receive the code on your iPhone, enter it on the android device and wait for the Honor X9b devices to connect. Select all the content you want to move and click Next.
...
- **Move to iOS could not communicate correctly with the Honor X9b devices.**
...
- Ensure the Honor X9b devices have enough power to complete the process/ plug the Honor X9b devices into power
...
You should ensure that both the android and iOS devices have sufficient power to run through the entire data transfer process. If you doubt the power consumption, keep the Honor X9b devices connected to power before you start moving your content from android to iOS device.
...
![connect your Honor X9bs](https://images.wondershare.com/drfone/guide/transfer-ios-to-android-1.png)

- Select the types of data you want to transfer, then click on the 'start transfer' option to continue. Be careful not to disconnect the Honor X9b devices until the process is complete.
