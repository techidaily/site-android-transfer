---
title: In 2024, How to Transfer Photos from Poco C50 to Laptop Without USB | Dr.fone
date: 2024-07-18T01:28:33.207Z
updated: 2024-07-19T01:28:33.207Z
tags: 
  - transfer
categories:
  - android
...
keywords: transfer from android to android,transfer from android to ipad,transfer from android to iphone,transfer from Poco C50 to android,transfer from android to mac,transfer from Poco C50 to pc,transfer from Poco C50 to ipad,transfer from Poco C50 to mac,transfer from Poco C50 to iphone,transfer from android to pc
...
## How to Transfer Contacts from Poco C50 to Other Android Devices Using Bluetooth?
...
<!-- affiliate ads end -->
## Part I: How to Transfer Contacts from Poco C50 to Other Android Devices via Bluetooth?
...
## Part II: Other Methods to Transfer Contacts from Poco C50 to Other Android Devices
...
Now, Google will sync your contacts from the Poco C50 device onto the cloud, and your new device signed into the same Google Account will automatically download the contacts.
...
Step 2: Keep the Poco C50 devices close by, say, on the table. This will not work if the Poco C50 devices are in different rooms or too far away.

Step 3: Launch Smart Switch on both the Poco C50 devices
...
Step 3: Select the Phone Transfer module and connect your Poco C50s to the computer

![phone transfer](https://images.wondershare.com/drfone/guide/transfer-ios-to-android-1.png)

Step 4: When the Poco C50 devices are connected, select the Contacts category to transfer and click Start Transfer. Within seconds, your contacts will be transferred to the new device.
